...
if __name__ == '__main__':
    auth_form_invalid = AuthorizationForm('ivanov120', '1234k4534534')
    auth_form_valid = AuthorizationForm('BobTheBuilder', '1234k3453453')
    print(auth_form_invalid.valid_form(), auth_form_valid.valid_form())
