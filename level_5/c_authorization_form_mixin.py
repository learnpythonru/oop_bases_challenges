...
Задания:
    1. В классе AuthorizationFormMixin, в методе valid_form напишите логику проверки на наличие юзернейма
       в списке USERNAMES_IN_DB. Нужно использовать super() в этом методе
